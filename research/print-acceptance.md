...
`0a18a4e2ffcb0aff529760bf97ab1f42f7c8e76aa5ee6e5b72217985c02d917e`.
...
edition is 526 pages: the cover is page 1, printed contents begin on page 2
...
* evolog and template-reference pages 177, 179, 180, 182, 183, 241, and 242,
  rendered separately after the shell-template reflow.
...
readable following material. The evolog section and its long executable
template examples were additionally rendered on pages 177, 179, 180, 182,
and 183; the JSON-output and daily-log template examples were rendered on
pages 241 and 242. Continuation lines remain fully visible inside the code
blocks and page margins. The locator searches for these headings after the body
boundary, so it cannot mistake a printed contents entry for the current body
page.
