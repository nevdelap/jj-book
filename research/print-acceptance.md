...
* fixed pages 1–4, 109, 147, 313, 479, 492, and 501;
* current body pages 169 (Part XII), 172 (workspace laboratory), 177 (Part
  XIII), 184 (configuration laboratory), and 186 (configuration reference).
